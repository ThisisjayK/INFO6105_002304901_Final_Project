...
# https://github.com/ThisisjayK/INFO6105_002304901_Final_Project
data_url <- paste0(
  "https://raw.githubusercontent.com/ThisisjayK/",
  "INFO6105_002304901_Final_Project/",
  "a40778ba72b44c8ae53b8dc7daa17882af4a28a4/",
  "github_repos.csv"
)
...
cat("R-squared:         ",
    round(mlr_summary$r.squared, 4), "\n")
cat("Adjusted R-squared:",
    round(mlr_summary$adj.r.squared, 4), "\n")
cat("F-statistic:       ",
    round(mlr_summary$fstatistic[1], 2), "\n")
...
spearman_result <- cor.test(github_data$stargazers_count, github_data$forks_count,
                            method = "spearman")
cat("Spearman rho:",
    round(spearman_result$estimate, 4), "\n")
cat("p-value:     ",
